...
English version of this notice: NOTICE
...
Trademark Holdings, LLC. Apple i iPhone są znakami towarowymi Apple Inc.

Nazwa i logo mintstudio (docs/assets/mintstudio*.png) nie są objęte
licencją GPL; wszelkie prawa zastrzeżone.
